...
const getLostProfit = async () => {
    ...
    let url = `/api/home/lost-profit?&month=${month}&year=${year}`;
...
const getAsset = async () => {
    ...
    let url = `/api/home/asset?time_limit=${timeLimit}&month_selected=${month}&year_selected=${year}`;
...
const getLiability = async () => {
    ...
    let url = `/api/home/liability?time_limit=${timeLimit}&month_selected=${month}&year_selected=${year}`;
...
const getEquity = async () => {
    ...
    let url = `/api/home/equity?time_limit=${timeLimit}&month_selected=${month}&year_selected=${year}`;
