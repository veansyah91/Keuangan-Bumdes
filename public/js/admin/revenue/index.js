...
async function showRevenue(){
    try {
        let url = `/api/revenue?search=${search}&page=${page}&date_from=${date_from}&date_to=${date_to}&this_week=${thisWeek}&this_month=${thisMonth}&this_year=${thisYear}`;
...
function goToPrintRevenuePerId(value){
    window.open(`/revenue/print-detail/${value.dataset.id}`)
}

function goToPrintRevenues(){
    window.open(`/revenue/print?search=${search}&date_from=${date_from}&date_to=${date_to}&this_week=${thisWeek}&this_month=${thisMonth}&this_year=${thisYear}`)
}
