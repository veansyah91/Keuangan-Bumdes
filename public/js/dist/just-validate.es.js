    ...
    for (const fieldName in this.fields) {
      ...
      if (field.isValid) {
        if (!field.asyncCheckPending) {
          ...
          if (successLabel) {
            this.renderFieldLabel(field.elem, successLabel, (_e = field.config) == null ? void 0 : _e.errorsContainer, true);
          }
          field.elem.classList.add(((_f = field.config) == null ? void 0 : _f.successFieldCssClass) || this.globalConfig.successFieldCssClass);
        }
        continue;
      }
      this.isValid = false;
      field.elem.classList.add(((_g = field.config) == null ? void 0 : _g.errorFieldCssClass) || this.globalConfig.errorFieldCssClass);
      const errorLabel = this.createErrorLabelElem(fieldName, field.errorMessage, field.config);
      this.renderFieldLabel(field.elem, errorLabel, (_h = field.config) == null ? void 0 : _h.errorsContainer);
      if (this.isTooltip()) {
        this.tooltips.push(this.renderTooltip(field.elem, errorLabel, (_j = (_i = field.config) == null ? void 0 : _i.tooltip) == null ? void 0 : _j.position));
      }
    }
  }
  destroy() {
