...
async function showCashMutation(){
    try {
        let url = `/api/${business}/cash-mutation?search=${search}&page=${page}&date_from=${date_from}&date_to=${date_to}&this_week=${thisWeek}&this_month=${thisMonth}&this_year=${thisYear}`;
...
function goToPrintCashMutationPerId(value){
    window.open(`/${business}/cash-mutation/print-detail/${value.dataset.id}`)
}

function goToPrintCashMutations(){
    window.open(`/${business}/cash-mutation/print?search=${search}&date_from=${date_from}&date_to=${date_to}&this_week=${thisWeek}&this_month=${thisMonth}&this_year=${thisYear}`)
}
