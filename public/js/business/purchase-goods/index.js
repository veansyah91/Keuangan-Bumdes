...
async function showPurchaseGoods(){
    try {
        let response = await getPurchaseGoods(search,page, date_from, date_to, thisWeek, thisMonth, thisYear);
                ...
                <div style="width:5%" class="my-auto">
                    <div class="btn-group dropstart">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton${index}">
                            <li>
                                <button class="dropdown-item" href="#"  data-bs-toggle="modal" data-bs-target="#showDetailModal" onclick="showSinglePurchaseGoods(${res.id})" >
                            ...
                            <li>
                                <a class="dropdown-item" href="/${res.business_id}/purchase-goods/${res.id}/edit" >
                            ...
                            <li>
                                <button class="dropdown-item" href="#"  data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal" onclick="deletePurchaseGoods(${res.id})" >
...
function deletePurchaseGoods(id){
    deleteId = id;
}

async function submitDeletePurchaseGoods(){
    try {
        let response = await destroyPurchaseGoods(deleteId);
...
async function showSinglePurchaseGoods(id){
    try {
        let res = await getSinglePurchaseGoods(id);
        ...
        document.querySelector('#btn-submit-print-single').setAttribute('href',`/${res.business_id}/purchase-goods/${res.id}/print-detail`);
...
function goToPrintPurchaseGoodss(){
    window.open(`/${business}/purchase-goods/print?search=${search}&date_from=${date_from}&date_to=${date_to}&this_week=${thisWeek}&this_month=${thisMonth}&this_year=${thisYear}`)
}
