...
@section('admin')
    <div class="page-heading d-flex justify-content-between my-auto">
        ...
        <div class="d-flex">
            ...
            <div class="mx-1">
                <button class="btn btn-outline-secondary" id="print-button" onclick="goToPrintLedgers()"><i class="bi bi-printer"></i></button>
            </div>
...
@section('script')
    <script src="/js/admin/ledger/index.js"></script>
