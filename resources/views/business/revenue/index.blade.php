...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        ...
        <div class="d-flex">
            ...
            <div class="mx-1">
                <button class="btn btn-outline-secondary" onclick="goToPrintRevenues()"><i class="bi bi-printer"></i></button>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="fw-bold d-md-flex d-none justify-content-between font-bold border-top border-bottom py-2 px-1">
                    ...
                    <div style="width:29%" class="px-2 my-auto">Deskripsi</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4>Hapus Data Pendapatan ?</h4>
                    
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-primary" id="btn-submit-delete" data-bs-dismiss="modal" onclick="submitDeleteRevenue()">
                        Hapus    
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showDetailModalLabel">Detail Pendapatan</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-primary" id="btn-submit-print-single" onclick="goToPrintRevenuePerId(this)" data-bs-dismiss="modal">
                        Cetak    
                    </button>
                </div>
            </div>
...
@section('script')
    <script src="/js/business/revenue/index.js"></script>
    <script src="/js/business/revenue/api.js"></script>
@endsection
