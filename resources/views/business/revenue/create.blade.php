...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('business.revenue.index', $business->id) }}">Pendapatan</a></li>
              <li class="breadcrumb-item active" aria-current="page">Tambah Pendapatan</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-end pt-2 border-bottom pb-2 font-bold">
                    <div class="col-lg-2 col-6 text-end">
                        <a class="btn btn-outline-primary w-100" href="{{ route('business.revenue.index', $business->id) }}">Batal</a>
                    </div>  
...
@section('script')
    ...
    <script src="/js/business/revenue/create.js"></script>
@endsection
