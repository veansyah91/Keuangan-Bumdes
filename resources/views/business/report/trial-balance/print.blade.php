...
<head>
    ...
    <title>Print Neraca Saldo Tahunan</title>
...
<body>
    <div class="p-4">
        ...
        <div class="row justify-content-center mb-2" data-business="{{ $business->id }}" id="content">
            <div class="col-12 text-center">
                <h5 class="text-black font-bold" style="font-size: 16pt">Laporan Neraca Saldo
                <h5 class="text-black font-bold" style="font-size: 12pt">Untuk Tahun yang Berakhir Pada Tanggal 31 Desember <span class="periods" id="period"></span>
                ...
                <div class="col-12">
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <tr>
                                <th class="text-end">Debit (IDR)</th>
                                <th class="text-end">Kredit (IDR)</th>
                                <th class="text-end">Debit (IDR)</th>
                                <th class="text-end">Kredit (IDR)</th>
                                <th class="text-end">Debit (IDR)</th>
                                <th class="text-end">Kredit (IDR)</th>
    ...
    <script src="/js/business/report/trial-balance-print.js"></script>
