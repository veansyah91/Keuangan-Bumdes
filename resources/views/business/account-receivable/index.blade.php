        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="fw-bold d-md-flex d-none justify-content-between font-bold border-top border-bottom py-2 px-1">
                    ...
                    <div style="width:20%" class="px-2 my-auto">Nama Pelanggan</div>
                    <div style="width:20%" class="px-2 my-auto text-end">Total Piutang (IDR)</div>
                    <div style="width:20%" class="px-2 my-auto text-end">Lunas (IDR)</div>
                    <div style="width:20%" class="px-2 my-auto text-end">Sisa (IDR)</div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showDetailModalLabel">Detail Piutang</h5>
                ...
                <div class="modal-body">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 70%" id="name-detail">: </td>
                                    </tr>
                                    <tr>
                                        <th style="width: 30%">Alamat</th>
                                        <td style="width: 70%" id="address-detail">: </td>
                                    </tr>
                                    <tr>
                                        <th style="width: 30%">No HP</th>
                                        <td style="width: 70%" id="phone-detail">: </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div id="invoices">
                        <div class="row justify-content-between">
                            ...
                            <div class="col-4 d-flex jusfity-content-between">
                                <div class="col">
                                    Nilai Penjualan: Rp.  
                                </div>
                                <div class="col">
...
@section('script')
    <script src="/js/business/account-receivable/index.js"></script>
    <script src="/js/business/account-receivable/api.js"></script>
@endsection
