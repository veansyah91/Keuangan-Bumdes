...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        ...
        <div class="d-flex">
            ...
            <div class="mx-1">
                <button class="btn btn-outline-secondary" onclick="goToPrintExpenses()"><i class="bi bi-printer"></i></button>
            </div>
            
        </div>
        <div class="d-none d-md-block">
            <a class="btn btn-primary" href="{{ route('business.expense.create', $business->id) }}">Tambah Data</a>
        </div>
        <div class="fixed-bottom text-end mb-3 mr-3 d-md-none ">
            <a class="btn btn-primary rounded-circle" href="{{ route('business.expense.create', $business->id) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4>Hapus Data Pengeluaran ?</h4>
                    
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-primary" id="btn-submit-delete" data-bs-dismiss="modal" onclick="submitDeleteExpense()">
                        Hapus    
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showDetailModalLabel">Detail Pengeluaran</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-primary" id="btn-submit-print-single" onclick="goToPrintExpensePerId(this)" data-bs-dismiss="modal">
                        Cetak    
                    </button>
                </div>
            </div>
...
@section('script')
    <script src="/js/business/expense/index.js"></script>
    <script src="/js/business/expense/api.js"></script>
@endsection
