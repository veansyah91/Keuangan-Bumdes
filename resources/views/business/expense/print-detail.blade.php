            ...
            <table class="table mt-5">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-end" style="width: 25%">Rp.{{ number_format($businessexpense->value, 0, '', '.')}}</th>
                        <th class="text-end" style="width: 25%">Rp.{{ number_format($businessexpense->value, 0, '', '.')}}</th>
                    </tr>
                </tfoot>
            </table>
