...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        <h3>Ubah Pengeluaran</h3>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('business.expense.index', $business->id) }}">Pengeluaran</a></li>
              <li class="breadcrumb-item active" aria-current="page">Ubah Pengeluaran</li>
            </ol>
        </nav>
    </div>

    <div class="page-content" id="page-content" data-id="{{ $expense_id }}">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-end pt-2 border-bottom pb-2 font-bold">
                    <div class="col-lg-2 col-6 text-end">
                        <a class="btn btn-outline-primary w-100" href="{{ route('business.expense.index', $business->id) }}">Batal</a>
                    </div>  
...
@section('script')
    ...
    <script src="/js/business/expense/edit.js"></script>
@endsection
