...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        <h3>Ubah Mutasi Kas</h3>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('cash-mutation.index') }}">Mutasi Kas</a></li>
              <li class="breadcrumb-item active" aria-current="page">Ubah Mutasi Kas</li>
            </ol>
        </nav>
    </div>

    <div class="page-content" id="page-content" data-id="{{ $cash_mutation_id }}">
        <div class="card">
            <div class="card-body">
...
@section('script')
    ...
    <script src="/js/business/cash-mutation/edit.js"></script>
@endsection
