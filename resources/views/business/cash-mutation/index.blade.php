...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content"> 
        ...
        <div class="d-none d-md-block">
            <a class="btn btn-primary" href="{{ route('business.cash-mutation.create', $business->id) }}">Tambah Data</a>
        </div>
        <div class="fixed-bottom text-end mb-3 mr-3 d-md-none ">
            <a class="btn btn-primary rounded-circle" href="{{ route('business.cash-mutation.create', $business->id) }}">
...
@section('script')
    <script src="/js/business/cash-mutation/index.js"></script>
