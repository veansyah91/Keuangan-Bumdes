...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('business.cash-mutation.index', $business->id) }}">Mutasi Kas</a></li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4" >
                        <div class="mb-3">
                            <label for="to-account" class="form-label">Nilai</label>
                            <div class="position-relative">
                ...
                <div class="row justify-content-end pt-2 border-bottom pb-2 font-bold">
                    <div class="col-lg-2 col-6 text-end">
                        <a class="btn btn-outline-primary w-100" href="{{ route('business.cash-mutation.index', $business->id) }}">Batal</a>
                    </div>  
...
@section('script')
    <script src="/js/business/cash-mutation/api.js"></script>
    <script src="/js/business/cash-mutation/create.js"></script>
@endsection
