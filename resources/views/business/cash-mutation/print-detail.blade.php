    ...
    <div class="m-4 p-4">
        ...
        <div style="font-size:12pt;">
            <div class="row p-1">
                ...
                <div class="col-9">
                    : {{ $businesscashmutation->date_format }}
                </div>
            </div>
            ...
            <div class="row p-1">
                ...
                <div class="col-9">
                    : {{ $businesscashmutation->description }}
                </div>
            </div>
            ...
            <table class="table mt-5">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-end" style="width: 25%">Rp.{{ number_format($businesscashmutation->value, 0, '', '.')}}</th>
                        <th class="text-end" style="width: 25%">Rp.{{ number_format($businesscashmutation->value, 0, '', '.')}}</th>
                    </tr>
                </tfoot>
            </table>
