...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        ...
        <div class="d-none d-md-block">
            <a class="btn btn-primary" href="{{ route('business.inventory-adjustment.create', $business->id) }}">Tambah Data</a>
        </div>
        <div class="fixed-bottom text-end mb-3 mr-3 d-md-none ">
            <a class="btn btn-primary rounded-circle" href="{{ route('business.inventory-adjustment.create', $business->id) }}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="fw-bold d-md-flex d-none justify-content-between font-bold border-top border-bottom py-2 px-1">
                    ...
                    <div style="width:20%" class="px-2 my-auto">No. Referensi</div>
                    <div style="width:40%" class="px-2 my-auto">Deskripsi</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4>Hapus Data Penyesuaian Barang ?</h4>
                    
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-primary" id="btn-submit-delete" data-bs-dismiss="modal" onclick="submitDeleteInventoryAdjustment()">
                        Hapus    
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showDetailModalLabel">Detail Penyesuaian Barang</h5>
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="row justify-content-start text-start p-2">
                        ...
                        <div class="col-10 font-bold text-start" id="credit-account-detail">
...
@section('script')
    <script src="/js/business/inventory-adjustment/index.js"></script>
