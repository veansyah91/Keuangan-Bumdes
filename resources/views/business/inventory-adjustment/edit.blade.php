...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" data-inventory-adjustment="{{ $inventoryadjustment->id }}" id="content">
        <h3>Ubah Penyesuaian Barang</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no-ref-input" placeholder="Kode Akun" onchange="noRefChange(this)" disabled>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
...
@section('script')
    ...
    <script src="/js/business/inventory-adjustment/edit.js"></script>
@endsection
