...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" data-purchase-goods="{{ $purchaseGoods }}" id="content">
        <h3>Ubah Faktur Pembelian Barang</h3>
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('business.purchase-goods.index', $business->id) }}">Faktur Pembelian Barang</a></li>
              <li class="breadcrumb-item active" aria-current="page">Faktur Pembelian Barang</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="mb-3 position-relative">
                            <label for="contact-input" class="form-label fw-bold">Supplier</label>
                ...
                <div class="row justify-content-start pt-2 border-bottom pb-2 fw-bold">
                    <div class="col-lg-6 col-12">
                        <div class="row">
                            ...
                            <div class="col-6 position-relative" id="account-credit">
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control search-input-dropdown" placeholder="Akun" aria-label="Akun" aria-describedby="account-credit-input" list="data-account" onclick="showAccountCreditDropdown(this)" onkeyup="showAccountCreditDropdown(this)"
                                    onchange="changeAccountCredit(this)" id="account-credit-input" autocomplete="off">
                                </div>
                                <div class="bg-light position-absolute list-group w-100 d-none search-select overflow-auto custom-scroll border border-2 border-secondary dropdown-menu-end" id="account-credit-list" style="max-height: 130px">
                ...
                <div class="row justify-content-start pt-2 border-bottom pb-2 fw-bold">
                    <div class="col-lg-2 col-6 text-end">
                        <a class="btn btn-outline-primary w-100" href="{{ route('business.purchase-goods.index', $business->id) }}">Batal</a>
                    </div>  
                    <div class="col-lg-2 col-6 text-end d-none" id="btn-submit-purchase-goods">
                        <button class="btn btn-primary w-100" onclick="submitPurchaseGoods()" id="btn-submit">
...
@section('script')
    ...
    <script src="/js/business/purchase-goods/edit21052023.js"></script>
@endsection
