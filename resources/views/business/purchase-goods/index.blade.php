...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        ...
        <div class="d-none d-md-block">
            <a class="btn btn-primary" href="{{ route('business.purchase-goods.create', $business->id) }}">Tambah Data</a>
        </div>
        <div class="fixed-bottom text-end mb-3 mr-3 d-md-none ">
            <a class="btn btn-primary rounded-circle" href="{{ route('business.purchase-goods.create', $business->id) }}">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="fw-bold d-md-flex d-none justify-content-between font-bold border-top border-bottom py-2 px-1">
                    ...
                    <div style="width:20%" class="px-2 my-auto text-start">Supplier</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn-submit-delete" data-bs-dismiss="modal" onclick="submitDeletePurchaseGoods()">
                        Hapus    
                    </button>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showDetailModalLabel">Faktur Pembelian</h5>
