...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        <h3>Tambah Faktur Pembelian Barang</h3>
        ...
        <div class="card">
            <div class="card-body ">
                ...
                <div class="row justify-content-start pt-2 border-bottom pb-2 fw-bold">
                    ...
                    <div class="col-lg-3 col-6 text-end d-none" id="btn-submit-purchase-goods">
...
@section('script')
    ...
    <script src="/js/business/purchase-goods/create21052023.js"></script>
@endsection
