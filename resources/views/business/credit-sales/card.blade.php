...
<head>
    ...
    <title>Print Kartu Pembayaran Kredit</title>
            ...
            <div class="m-4 p-4">
                ...
                <div class="row justify-content-center my-2 ">
                    <div class="col-12 text-center">
                        <h4 class="text-gray font-bold">Kartu Pembayaran Kredit</h4>
                    </div>
                </div>
                        ...
                        <div class="col-12 col-md-6">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th style="width: 40%">DP (IDR)</th>
                                        <td style="width: 60%" id="downpayment-detail">:{{ number_format($accountReceivable->creditApplication->downpayment, 0, '', '.')}}</td>
                                    </tr>
                                    <tr>
                                        <th style="width: 40%">Tenor</th>
                                        <td style="width: 60%" id="tenor-detail">:{{  $accountReceivable->creditApplication->tenor }}</td>
                                    </tr>
                                    <tr>
                                        <th style="width: 40%">Angsuran Per Bulan (IDR)</th>
                                        <td style="width: 60%" id="installment-detail">:{{ number_format($accountReceivable->debit / $accountReceivable->creditApplication->tenor, 0, '', '.')}}</td>
                                    </tr>
                                    <tr>
