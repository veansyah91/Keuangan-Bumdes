        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="fw-bold d-md-flex d-none justify-content-between fw-bold border-top border-bottom py-2 px-1">
                    ...
                    <div style="width:12%" class="px-2 my-auto">Tanggal</div>
                    <div style="width:12%" class="px-2 my-auto text-start">Jatuh Tempo</div>                    
                    <div style="width:15%" class="px-2 my-auto">No. Ref</div>
                    <div style="width:20%" class="px-2 my-auto">No. HP</div>
                    <div style="width:15%" class="px-2 my-auto">Nama</div>
                    <div style="width:20%" class="px-2 my-auto text-end">Nilai Pinjaman (IDR)</div>                    
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4>Hapus Data Pemberian Pinjaman ?</h4>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="showDetailModalLabel">Detail Pemberian Pinjaman</h5>
                    ...
                    <div>
                        ...
                        <div class="tab-content overflow-auto custom-scroll" id="myTabContent"  style="height: 330px;">
                            <div class="tab-pane fade show active" id="home-detail" role="tabpanel" aria-labelledby="home-tab">
                                <div class="mt-3">
                                    <div class="fw-bold">Jumlah Pemberian (IDR)</div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body overflow-auto custom-scroll" style="height: 400px;"> 
                        ...
                        <div class="position-relative z-index-1 mt-3">
                            <div class="">
                                <label for="debt-submission-input" class="form-label fw-bold">No. Pengajuan Pinjaman (Optional)</label>
                                <div class="mb-1 d-flex">
                                    <input type="text" class="form-control search-input-dropdown" placeholder="No. Pengajuan" aria-label="No. Pengajuan" aria-describedby="create-address" onclick="showDebtSubmissionDropdown(this)" onkeyup="changeDebtSubmissionDropdown(this)" onchange="changeDebtSubmission(this)" id="debt-submission-input" autocomplete="off">
                                    <button type="button" class="btn" id="btn-search-order" onclick="deleteDebSubmission()">
                                        <i class="bi bi-x-circle"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="bg-light position-absolute list-group w-100 search-select overflow-auto custom-scroll border border-2 border-secondary d-none" id="debt-submission-list" style="max-height: 130px">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control" id="name-input" placeholder="Nama" readonly>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control text-end tenor-input" 
                            inputmode="numeric" autocomplete="off" 
                            onclick="this.select()" value="0" onkeyup="setCurrencyFormat(this)" onchange="changeTenor(this)" data-order="0" id="tenor-input">
                        </div>
                        <div class="mt-3">
                            <label for="installment-input" class="form-label fw-bold">Angsuran Per Bulan ( IDR)</label>
                            <input type="text" class="form-control text-end" 
                            inputmode="numeric" autocomplete="off" 
                            onclick="this.select()" value="0" onkeyup="setCurrencyFormat(this)" data-order="0" id="installment-input" readonly>
                        </div>
                        <div class="mt-3">
                            <label for="term-input" class="form-label fw-bold">Tempo</label>
                            <input type="date" class="form-control" id="term-input" placeholder="Tanggal" onchange="changeTerm(this)">
                        </div> 

                        <div class="position-relative z-index-1 mt-3">
                            <div class="">
                                <label for="contact-input" class="form-label fw-bold">Kas (Akun Kredit)</label>
                                <div class="mb-1">
                                    <input type="text" class="form-control search-input-dropdown" placeholder="Kas (Akun Kredit)" aria-label="NIK" aria-describedby="account" onclick="showAccountDropdown(this)" onkeyup="changeAccountDropdown(this)" onchange="changeAccount(this)" id="account-input" autocomplete="off">
                                </div>
                            </div>
...
@section('script')
    <script src="/js/business/lend/index.js"></script>
    <script src="/js/business/lend/api.js"></script>
@endsection
