...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('business.journal.index', $business->id) }}">Jurnal</a></li>
              <li class="breadcrumb-item active" aria-current="page">Ubah Jurnal</li>
            </ol>
        </nav>
    </div>

    <div class="page-content" id="page-content" data-id="{{ $journal->id }}">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row justify-content-end pt-2 border-bottom pb-2 font-bold">
                    <div class="col-lg-2 col-6 text-end">
                        <a class="btn btn-outline-primary w-100" href="{{ route('business.journal.index', $business->id) }}">Batal</a>
                    </div>  
