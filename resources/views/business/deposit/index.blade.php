        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="showDetailModalLabel">Detail Setor Tunai</h5>
...
@section('script')
    <script src="/js/business/deposit/index.js"></script>
    <script src="/js/business/deposit/api.js"></script>
@endsection
