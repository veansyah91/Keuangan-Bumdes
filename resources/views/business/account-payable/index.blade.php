        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="fw-bold d-md-flex d-none justify-content-between font-bold border-top border-bottom py-2 px-1">
                    ...
                    <div style="width:20%" class="px-2 my-auto text-end">Total Utang (IDR)</div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showDetailModalLabel">Detail Utang</h5>
...
@section('script')
    <script src="/js/business/account-payable/index.js"></script>
    <script src="/js/business/account-payable/api.js"></script>
@endsection
