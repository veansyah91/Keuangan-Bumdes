...
@section('content')
    <div class="page-heading d-flex justify-content-between my-auto" data-business="{{ $business->id }}" id="content">
        ...
        <div class="d-flex">
            <div class="d-lg-flex input-group mb-3 mx-1 d-none position-relative">
            ...
            <div class="mx-1">
                <a class="btn btn-outline-secondary" id="print-button" target="_blank"><i class="bi bi-printer"></i></a>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="fw-bold d-md-flex d-none justify-content-between font-bold border-top border-bottom py-2 px-1">
                    ...
                    <div style="width:15%" class="px-2 my-auto">Tanggal</div>
                    <div style="width:15%" class="px-2 my-auto">No. Referensi</div>
                    <div style="width:20%" class="px-2 my-auto">Deskripsi</div>
                    <div style="width:20%" class="px-2 text-end my-auto">Debit (IDR)</div>
                    <div style="width:20%" class="px-2 text-end my-auto">Credit (IDR)</div>
                    
                </div>

                <div style="height: 320px;" class="overflow-auto custom-scroll" id="list-data">
                </div>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="row">
                                <div class="col-12 col-md-4 font-weight-bold ">
                                    <div>Saldo Awal</div>
                                    <div class="h4 text-white" id="opening-balance">Rp. -</div>
                                </div>
                                <div class="col-12 col-md-4 font-weight-bold ">
                                    <div>Mutasi</div>
                                    <div class="h4 text-white" id="mutation">Rp. -</div>
                                    
                                </div>
                                <div class="col-12 col-md-4 font-weight-bold ">
                                    <div>Saldo Akhir</div>
                                    <div class="h4 text-white" id="ending-balance">
                                        Rp. -
                                    </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="row">
                                <div class="col-12 col-md-6 font-weight-bold text-right">
                                    ...
                                    <div class="h5 text-white" id="total-debit">
                                        Rp. -
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 font-weight-bold text-right">
                                    ...
                                    <div class="h5 text-white" id="total-credit">
                                        Rp. -
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script src="/js/business/ledger/index.js"></script>
    <script src="/js/business/ledger/api.js"></script>
@endsection
