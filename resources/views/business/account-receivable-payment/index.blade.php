...
@section('content')
    ...
    <!-- Modal -->
    {{-- Create or Edit Akun --}}
    <form onsubmit="submitAccountReceivable(event)">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4>Hapus Data Pembayaran Piutang?</h4>
                    
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-primary" id="btn-submit-delete" data-bs-dismiss="modal" onclick="submitDeleteAccountReceivablePayment()">
                        Hapus    
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="showDetailModal" tabindex="-1" aria-labelledby="showDetailModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="showDetailModalLabel">Faktur Pembayaran Piutang</h5>
...
@section('script')
    <script src="/js/business/account-receivable-payment/index.js"></script>
    <script src="/js/business/account-receivable-payment/api.js"></script>
@endsection
