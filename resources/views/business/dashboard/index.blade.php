                        ...
                        <div class="row justify-content-between">
                            <div class="col-12">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-10">
                                        <div class="h5 text-black-50 fw-bold" >
                                            Asset
                                        </div>
                                        <div class="fw-bolder h4 text-info" id="asset">
                            ...
                            <div class="col-12">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <div class="fw-bolder h4 text-warning" id="liability">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <div class="fw-bolder h4 text-success" id="equity">
                                        </div>
                                    </div>
                                </div>
                            </div>
